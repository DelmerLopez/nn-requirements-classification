...
if __name__=='__main__':
    ...
    weights = [30, 20, 20, 10]
    num_classes = [6, 5, 4, 3]
    mutation_p = [0.8, 0.8, 0.6,0.6]

    for x_dataset, y_dataset, weight, num_class, m_number in zip(x_datasets, y_datasets, weights, num_classes, mutation_p):
        ...
        for train_index, test_index in kf.split(x, y):
            ...
            vs.draw_net(config, winner, False, filename=os.path.join(dirname, str(num_class) + str(m_number) + '-winner-' + str(n_fold)))
